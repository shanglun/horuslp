...
from horuslp_gurobi.core.Variables import BinaryVariableGroup
from horuslp_gurobi.core import Constraint, VariableManager, Problem, Metric, ObjectiveComponent
...
class UniquenessConstraints(Constraint):
    def __init__(self, model):
        super(UniquenessConstraints, self).__init__(model)
